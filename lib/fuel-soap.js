...
FuelSoap.prototype.perform = function(type, def, callback) {
	...
	// defAndCallback = determineCallbackAndOptions(arguments, callback, def);
	// callback = defAndCallback.callback;

	var totalArguments = arguments.length;
	console.log('arguments length: ' + arguments.length);
	console.log(typeof arguments[totalArguments - 1])
	callback = arguments[totalArguments - 1];

	// def  = defAndCallback.def;
	console.log('fuel soap definiton')
	console.log(type);
	console.log(def);
